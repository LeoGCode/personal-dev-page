...
Cada landing incluye un formulario de contacto que pasa por un pipeline estricto: validación del lado del cliente con Zod, re-validación del lado del servidor en un route handler de Next.js, y después una llamada JSON-RPC a Odoo CRM. Cada lead se etiqueta automáticamente con la landing de origen, tipo de servicio, idioma y variante — así la vista de ventas en Odoo muestra exactamente de dónde vino cada lead.
