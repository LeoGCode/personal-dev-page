...
export const collaborateFormSchema = z.object({
  ...
  collaborationType: z.enum(["project", "consulting", "opensource", "speaking", "other"]),
  description: z.string().min(20, "Please provide at least 20 characters"),
  budget: z.enum(["unsure", "under_1k", "1k_5k", "5k_15k", "over_15k"]).optional(),
  timeline: z.enum(["no_rush", "1_3_months", "3_6_months", "asap"]).optional(),
  referral: z.enum(["google", "github", "linkedin", "referral", "other"]).optional(),
